...
import { getProductIlacDocuments } from "../../firebase/firebaseAuth";

const CategoryScreenIlac = ({ ad, fiyat, yer, id }) => {
  const navigation = useNavigation();
  const [productIlacData, setProductIlacData] = useState()


  getProductIlacDocuments().then((productIlac) => {

    setProductIlacData(productIlac);
...
export default CategoryScreenIlac